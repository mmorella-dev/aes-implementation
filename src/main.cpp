...
bool test_key_expansion()
{
    ...
    Bytes16 key = {0x0F, 0x15, 0x71, 0xC9, 0x47, 0xD9, 0xE8, 0x59, 0x0C, 0xB7, 0xAD, 0xD6, 0xAF, 0x7F, 0x67, 0x98};
    std::cerr << "Key: ";
    std::cerr << key << '\n';
    ...
    Bytes16 round1 = { 0xDC, 0x90, 0x37, 0xB0, 0x9B, 0x49, 0xDF, 0xE9, 0x97, 0xFE, 0x72, 0x3F, 0x38, 0x81, 0x15, 0xA7};
    Bytes16 round10 = { 0xB4, 0x8E, 0xF3, 0x52, 0xBA, 0x98, 0x13, 0x4E, 0x7F, 0x4D, 0x59, 0x20, 0x86, 0x26, 0x18, 0x76 };
